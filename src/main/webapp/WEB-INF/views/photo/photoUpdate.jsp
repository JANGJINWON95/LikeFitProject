...
<div id="write" class="col-lg-12 ftco-animate">
	<div class="container" style="padding: 0px 0px 60px">
		<form action="${pageContext.request.contextPath}/photo/updatePro" method="POST" enctype="multipart/form-data">
		...
		<div>
			<div class="left-b-box">
				<img src="${pageContext.request.contextPath}/resources/upload/${dto.photoImage}" class="image-box"/>
			...
			<div class="right-b-box">
				...
				<option selected>${dto.photoLocation}</option>
					<c:forEach var="areaList" items="${areaList}" >
						<c:if test="${areaList.area != dto.photoLocation}">
				...
				<div class="content" style="margin-top: 0.5em;">
					<textarea name="photoContent" class="txt-a" rows="18">${dto.photoContent}</textarea>
...
<script src="${pageContext.request.contextPath}/resources/js/photo-update.js"></script>
</body>
</html>