					...
					<div class="container">
						<div class="text-right">
							...
							<c:if test="${ReviewDTO.userId eq sessionScope.userId}">
								...
								<a href="${pageContext.request.contextPath}/review/delete?num=${ReviewDTO.reviewNum}" id="deleteBtnRe" class="btn btn-primary">삭제</a>
							</c:if>
				    	</div>
   					</div>
				                    ...
				                    <div class="form-group" id="">
									 <c:if test="${boardList.userId eq sessionScope.userId}">
										...
										<input type="button" value="글삭제" id="button2"
											onclick="location.href='${pageContext.request.contextPath }/board/redelete?num=${boardList.replyNum}&review_Num=${boardList.reviewNum}&reply_re_ref=${boardList.replyReRef}'"
...
<%--                       <input type="hidden" name="reply_re_ref" value="${ReviewDTO.replyReRef}"> --%>
