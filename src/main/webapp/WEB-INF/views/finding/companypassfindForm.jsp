...
<div id="container" class="container">
    <form id="fm" name="fm" action="${pageContext.request.contextPath}/finding/companypassfindPro" method="post" onsubmit="return checkSubmit()">
            ...
            <div class="find_wrap">
                <div class="find_inner">
                    ...
                    <div id="idInputRow" class="input_row">
                        ...
                        <input type="text" id="companyId3" class="input_name" name="companyId" maxlength="40">
                    </div>
                    <!-- 아이디 -->
                    ...
                    <div class="link_wrap">
                        <span class="text">
                            아이디가 기억나지 않는다면? <a href="${pageContext.request.contextPath}/finding/companyidfind" class="link"><div class="txt">아이디 찾기</div></a>
                        </span>
                    </div>
                </div>
            </div>
