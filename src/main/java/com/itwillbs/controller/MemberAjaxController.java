...
public class MemberAjaxController {
	...
	@RequestMapping(value = "/member/bestList", method = RequestMethod.GET)
	public ResponseEntity<List<ActivityDTO>> bestList(HttpServletRequest request){
	      
		List<ActivityDTO> mainList = mainService.getMainContentList();
		
		ResponseEntity<List<ActivityDTO>> entity=new ResponseEntity<List<ActivityDTO>>(mainList,HttpStatus.OK);
		
		return entity;
	}
	
	@RequestMapping(value = "/member/interestList", method = RequestMethod.GET)
	public ResponseEntity<List<ActivityDTO>> interestList(HttpServletRequest request){
		String userId=request.getParameter("sessionId");
		List<ActivityDTO> mainList = mainService.getMainInterestList(userId);
