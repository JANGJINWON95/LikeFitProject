...
*/
	...
	public String toString() {
		return "DateDTO [userId=" + userId + ", year=" + year + ", month=" + month + ", date=" + date + ", value="
				+ value + ", dbStartDate=" + dbStartDate + ", dbEndDate=" + dbEndDate + ", scheduleDataArr="
				+ Arrays.toString(scheduleDataArr) + "]";
	}
